...
- **Neira (экспериментальный ИИ‑модуль):** центральный индекс — [docs/neira/README.md](docs/neira/README.md)
...
JSON‑схемы хранятся в каталоге [schemas/](schemas/). При несовместимых изменениях повышайте версию: `1.0.0` → `1.1.0`.
