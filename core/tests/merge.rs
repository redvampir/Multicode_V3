use core::blocks::parse_blocks;

#[test]
fn stable_ids_preserved_when_appending() {
    let src1 = "fn a() {}\nfn b() {}\n".to_string();
    let blocks1 = parse_blocks(src1.clone(), "rust".into()).expect("первый парсинг");
    ...
    let blocks2 = parse_blocks(src2, "rust".into()).expect("второй парсинг");
