...
- Идентификатор
- Тип узла (краткий факт, правило, понятие и т.д.)
- Краткое описание
- Метаданные (ключевые слова, дата обновления, доверенный уровень источника)
- Ссылки на внутренние/внешние источники
- Приоритет и версии
