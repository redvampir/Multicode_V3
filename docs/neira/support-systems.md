...
Планировщик задаёт собственные операционные бюджеты использования ресурсов. Они используются для распределения задач и не отражают фактических ограничений железа.
...
Значения берутся из конфигурации планировщика и при необходимости могут масштабироваться. Операционные лимиты намеренно ниже аппаратных, чтобы оставлять резерв для хоста и других процессов.
