...
4. **SSD** — постоянные узлы памяти и индексы, требующие быстрого чтения и записи.
5. **HDD** — архивы и редко запрашиваемые данные, переносимые в медленное хранилище.
6. **Базы данных** — активные располагаются на SSD, архивные — на HDD.
